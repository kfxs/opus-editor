 ...
 * re-measured, not grown, when `STAVE_RECV` was anchored: R1 57 → 35, R2 198 → 203, R3 438 → 455, total unchanged; S2c (R1 35 → 19, R6 336 → 325); S3a (R2 203 → 161, R6 325 → 324); S4a (R3 455 → 444, R5 136 → 133). Lower them as
...
const CEILINGS = {
  'R1 staff coords': 19,
  'R2 note ruler': 161,
  'R3 placement rules': 444,
  'R4 formatter': 98,
  'R5 paint+leftovers': 133,
  'R6 object graph': 324,
  'R7 numbers+fonts': 0,
}
