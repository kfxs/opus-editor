...
const CEILINGS = {
  'R1 staff coords': 20,
  'R2 note ruler': 193,
  'R3 placement rules': 198,
  'R4 formatter': 114,
  'R5 paint+leftovers': 109,
  'R6 object graph': 259,
  'R7 numbers+fonts': 5,
}
/** The specs' uses, one number: a spec that imports VexFlow has to move with its subject too. */
const TEST_CEILING = 279

/** ⚠️ The NAME ceilings, measured 2026-09-14 (map §9.3); S11e 'identifiers' 113 → 110. Same rule: lower them as renames land;
