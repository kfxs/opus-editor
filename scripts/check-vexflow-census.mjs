...
const CEILINGS = {
  'R1 staff coords': 20,
  'R2 note ruler': 185,
  'R3 placement rules': 135,
  'R4 formatter': 113,
  'R5 paint+leftovers': 104,
  'R6 object graph': 241,
  'R7 numbers+fonts': 5,
}
/** The specs' uses, one number: a spec that imports VexFlow has to move with its subject too. */
const TEST_CEILING = 243

/** ⚠️ The NAME ceilings, measured 2026-09-14 (map §9.3); S11e 'identifiers' 113 → 110; S12e 'identifiers in tests' 150 → 147. Same rule: lower them as renames land;
