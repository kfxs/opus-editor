...
| ⛔ CROSS-STAFF stems | **Gould p. 305** | *"a stem may extend from one stave to the other to take advantage of the other clef"* — a permission with **no geometry**, and that is the whole of it. Ross, Stone and G&L: **UNKNOWN**, searched and silent. ⭐ 2026-09-21: p. 305's second FIGURE (scan) draws the SPLIT CHORD — heads on both staves, one continuous stem, heads on their normal side; p. 317 (scan) says not to put heads on both sides of a shared stem; pp. 314–315 (scan) are the cross-staff BEAM rules, incl. the one number (**2½ spaces** minimum stem — OCR prints `2%`). Stone p. 12 §D + G&L p. 43 do speak, on beams only. Gardner Read: archive.org copies lending-gated (401). All of it: `docs/research/cross-staff-research.md`. |
