...
5. Move `GhostNote` and `PixelCoordinates` out of `types/music.ts` to the editor side; split the
   ...
   **b** the by-domain split behind the barrel — next.*
