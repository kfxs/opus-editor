...
>
> ⚠️ **Read `docs/braces-brackets-research.md` beside this one.** Its §3.3 measured the bracket's
...
This trap is already recorded for the key signature (`docs/key-signature-research.md` §9.4.2b) and it
...
half is already in `docs/key-signature-research.md`:
...
5. **Ross's bracket thickness** (from `docs/braces-brackets-research.md`, re-measured here on p. 156).
...
| `KEY_TO_METER_INK` | **1.15 sp** | Gould p. 41 *"1–1½"*, p. 42 figure label *"1–1½"*; Stone p. 45 **1.0** gap, stated. | ✅ **CONFIRMED** (already recorded in `docs/key-signature-research.md`). |
