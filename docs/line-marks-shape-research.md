...
> changes code. Batch 2 of `docs/engraving-number-inventory.md` §6.
>
> ⛔ **Out of scope:** vertical placement (padding / minFromStaff / glyph size, which is batch 1),
> line thickness (decided in `rendering/thinLineWeight.ts` and `docs/staff-line-research.md`), and
> hairpin aperture 1.5–2 sp (sourced in `docs/dynamics-line-and-hairpins-plan.md` §2.4b–d).
...
- `docs/ottava-plan.md` §1 (rules) and §"HIS EYE, 2026-08-13": the air before the hook and the
  continuation's direction are his; the dash, hook and min line are listed as still open.
- `docs/pedal-plan.md` §5.1a–5.3 and §12 (the five numbers owed to his eye).
- `docs/trill-plan.md` §1 rule 6 (the continuation label and its position) and §4.
- `docs/dynamics-line-and-hairpins-plan.md` §2.4b–d (engines, books, the ramp) and §13.1 (settled
  vs open).
...
- Middle and end segments repeat no sign (`docs/trill-plan.md` rule 6).
...
- Aperture does not grow with length (`docs/dynamics-line-and-hairpins-plan.md` §2.4b).
