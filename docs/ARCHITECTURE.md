...
> never *do we control this?*). ⚠️ 2026-09-19: VexFlow is REMOVED (`docs/vexflow-removal-map.md`
...
> audit (⚠️ 2026-09-19: VexFlow is now removed entirely — `docs/vexflow-removal-map.md` §9). The measurements then (all 38 `vexflow` imports lived in ONE directory; `Stave` is a coordinate
