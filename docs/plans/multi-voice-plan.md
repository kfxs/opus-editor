...
- **Tuplet brackets** (added 2026-06-25): when a bar has >1 voice, a tuplet's bracket follows the
  ...
  clamp — ⚠️ that clamp is ours since S8a, `engrave/marks/tupletPlacement`). Full design in `docs/plans/tuplet-control-plan.md`.
...
`engine/layout/restVoicePlacement.ts` (`docs/plans/multi-voice-rest-position-plan.md`).
