...
The third and last of the marking stamps, after `docs/plans/articulation-stamp-plan.md` and
`docs/plans/accidental-stamp-plan.md` — **read those first**; this doc records only where the tie
