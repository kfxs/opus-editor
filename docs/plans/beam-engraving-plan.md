...
> 📄 The parent is `docs/plans/own-engraving-engine.md`; this document is its **P4**. ⛔ Read §0 of that
> document first — the goal order, the twelve standing rules, and the one-line test. `docs/how-it-works/beaming.md`
...
> a beam imposes.
>
> 📄 **P4c's research is DONE and is `docs/research/beam-hook-research.md`** (2026-09-01) — four treatises,
...
>
> 📄 **P4b's research is DONE and is `docs/research/beam-slope-research.md`** (2026-09-01) — four treatises,
...
| … | the beam's own **stem lengths** | `applyStemExtensions` — ⚠️ the same research as P3e (`docs/research/stem-length-research.md`), from the other end. ⭐ **The RULE is ours since S7b** (`engrave/beams/beamedStems`, VexFlow's transcribed exactly — every stem meets the line), so a researched change is now an edit there; ⛔ none is made yet | ⏭️ port ✅, research change open |
...
⭐ **What "the three engine solutions" means**, and each is measured in `docs/research/beam-slope-research.md`
...
> picture agree with her own caption. 📄 `docs/research/spacing-model-research.md` §1c.
...
⭐ Since then S7a–d of `docs/history/vexflow-removal-map.md` made every one of those answers ours
...
`docs/plans/note-engraving-plan.md` §3 collects four places where *the room we reserve and the ink we draw
...
- ✅ **The SLOPE (P4b) — RESEARCHED, ⛔ not built: `docs/research/beam-slope-research.md`.** Six rules are
...
- ✅ **The FRACTIONAL BEAMS (P4c) — RESEARCHED *and* BUILT: `docs/research/beam-hook-research.md`.** The guess
...
- **`Stave.padding`** is ⛔ **not** here. It is a LAYOUT number and it moves with **P5**
  (`docs/plans/note-engraving-plan.md` §0.1 carries the correction).
