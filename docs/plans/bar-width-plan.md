...
**It is not more `leadingSpace`.** That client (docs/plans/note-spacing-plan.md) exists to open a *dead
...
> ⚠️ **Rebound from `Shift+Alt+…` by the note-offset "move vs offset" swap** (`docs/plans/note-offset-plan.md`
...
1. ✅ **CLOSED at P1.5 — "an empty bar does not shrink enough".** Reported three times, and the
   ...
   `docs/research/spacing-model-research.md` §6c.
