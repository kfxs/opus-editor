...
(`docs/history/modularity-plan-2026-07-28.md`) was about the *spine tax* the rule does not reach, and ended
...
> ⏭️ **2026-09-14:** `VEXFLOW_LEDGER_OVERHANG` was deleted in S1b of `docs/history/vexflow-removal-map.md`: its
...
2. The trill's end drag did not stop at a system break (`docs/plans/trill-plan.md` §18).
