...
> sketched in `docs/plans/staff-size-plan.md` §6b, and it is the one he is waiting for.
>
...
The same trap as `docs/plans/staff-size-plan.md` §7, and the same fix — proven the same day, when a staff
...
> 📄 `docs/plans/spacing-model-plan.md` §3b.
