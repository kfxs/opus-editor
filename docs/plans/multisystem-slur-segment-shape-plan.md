...
> `BEGIN + k×MIDDLE + END` (see `docs/plans/multisystem-slur-plan.md`). BEGIN runs from the
...
`docs/plans/engraving-overrides-plan.md` §3, DESIGN-PRINCIPLES). The departure is *justified*:
