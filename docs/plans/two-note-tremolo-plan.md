...
Extends `docs/plans/tremolo-plan.md`, which deferred this in §8: *"a different notation with a different
...
the trap the tie stamp already had and fixed (docs/plans/tie-stamp-plan.md §1.3).
...
⚠️ **This is NOT the single-note rule, and the difference is geometric.** There (docs/plans/tremolo-plan.md
