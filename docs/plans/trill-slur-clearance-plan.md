...
measure loop (`docs/plans/ottava-plan.md`; *"an ottava's VERTICAL is PIXEL-FREE, so no hoist"*), and that
...
which is the property `docs/plans/ottava-plan.md` chose deliberately; the hoist comment must be checked
