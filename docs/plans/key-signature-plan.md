...
evidence is digested in **`docs/research/key-signature-research.md`**, which is this plan's companion —
...
policy, not laziness — `docs/plans/json-io-plan.md`).
...
`docs/plans/own-engraving-engine.md` **P5 is literally "The staff and the header"** — where `headerInk.ts`
...
> 🚨 **RE-CONFIRMED 2026-09-01, and the re-confirming is the lesson.** `docs/research/header-spacing-research.md`
...
⭐⭐ **And it is not a new idea here — it is a second user of one we already have.** `docs/how-it-works/pdf-export.md`'s
...
- **The courtesy CLEF's side.** The literature is unanimous that a clef goes BEFORE the last barline
  ...
  not bundled here. (✅ Fixed 2026-09-12 — `docs/plans/barline-types-plan.md` §4.4a.)
...
📄 **`docs/research/key-signature-research.md`** — the evidence, digested from five passes run on 2026-08-27:
