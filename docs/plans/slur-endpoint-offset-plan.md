...
offset** — `docs/plans/engraving-overrides-plan.md` §8 says so in as many words: *what is drawn is
...
Written up where the reading side lives: **`docs/plans/trill-slur-clearance-plan.md` §9** (the four filing
