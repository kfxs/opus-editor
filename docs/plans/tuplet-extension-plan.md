...
Sibling to `docs/plans/tuplet-control-plan.md`, which is about the bracket's *position and look*. Three
...
class then still extended `Tuplet` for the note GRAPH — ✅ no longer since S12a of `docs/history/vexflow-removal-map.md`: a plain class of ours.
