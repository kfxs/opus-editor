...
`docs/plans/score-header-sketch.md`, and read its ⛔ note before treating any of it as the feature. His
...
(`docs/plans/score-header-sketch.md`). It takes its room as an input to the cast-off —
