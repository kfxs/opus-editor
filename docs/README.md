...
149 files. ⭐ **Sorted by KIND, in four folders** (2026-09-20) — `plans/` · `research/` · `how-it-works/` · `history/` —
...
- [music-font-switch-plan](plans/music-font-switch-plan.md) — the music face is a dev-shell choice (Leipzig, Sebastian); A · B · follow-ups 1–2 built; custom glyph set + house style = his call
- [grace-notes-plan](plans/grace-notes-plan.md) — WRITTEN 2026-09-22, nothing built — §0's seven decisions are PROPOSED (his call); the research behind it is [grace-notes-research](research/grace-notes-research.md)
- [text-font-switch-plan](plans/text-font-switch-plan.md) — the WORDS face is a separate choice (Edwin, Nepomuk); 🚨 Sebastian Text is not a words font; the music-text companion + the text ROLES table are open
