...
the three engines give for the same quantity. Rows are from `docs/engraving-number-inventory.md`
...
- ledger overhang beside an accidental or under a rest, `LEDGER_ACCIDENTAL_GAP`, and the ghost's
  3 px (`ledgerAccidentalClearance.ts`, `docs/ledger-line-length-research.md`);
- a rest tucking under an accidental (`docs/rest-accidental-kerning-research.md`);
...
- **Books** (`reference/README.md`):
  ...
  - Earlier findings are cited, not repeated: `docs/accidental-dot-research.md` §4,
    `docs/accidental-dot-engines.md` §2.4/§3/§4, `docs/spacing-model-research.md` §1d/§3,
    `docs/header-spacing-research.md` §2.8/§4.2/§4.4, `docs/cross-barline-beaming-plan.md`,
    `docs/beam-hook-research.md` §8.
