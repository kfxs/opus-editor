...
> from (§5).
>
> ⭐ Sibling of `docs/stem-length-research.md` (which did the TREATISES, §1 *THICKNESS* and §3.4) and
> `docs/staff-line-research.md` (the staff line, §5, which every ratio below divides by).
>
> **Headlines.**
...
**Already done — see `docs/stem-length-research.md` §1 (*THICKNESS*), §3.4, §5.4, §6.1.**
...
4. **Sebastian, Finale Jazz / Broadway / Ash, Ekmelos, Eugene** `stemThickness`. ⛔ No metadata JSON on
   disk (`docs/smufl-fonts-research.md` §3, §7).
