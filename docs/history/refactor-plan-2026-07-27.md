...
The first pass (`docs/history/refactor-plan.md`, 2026-07-18) fixed *content* — bugs, dead code,
...
From `docs/history/refactor-plan.md` (2026-07-18), settled and still settled:
