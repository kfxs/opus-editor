...
Sibling to `docs/history/render-performance-plan.md`, in the same relation as
`docs/research/spacing-model-research.md` is to its plan: **the plan is what we decided, this is what we
