...
> ⚠️ **2026-09-19 — VexFlow is REMOVED** (`docs/history/vexflow-removal-map.md`). Every object this plan
...
> for notes, but its readers are moving off it one at a time (`docs/plans/own-engraving-engine.md`
...
// whose getBoundingBox() unions attached modifiers (docs/history/tight-bbox-plan.md §3).
...
// down to the dynamic's ink and steal its clicks (docs/history/tight-bbox-plan.md §3).
