...
The 2026-07-27 pass (`docs/history/refactor-plan-2026-07-27.md`) was about *shape* — where feature `n+1`
...
And against the *first* split plan's own baseline (`docs/history/split-plan-2026-06-22.md`, five weeks ago):
...
- **The "Where does X live?" rows refreshed**, because three of them had just been made stale by
  ...
  is the failure mode `docs/history/refactor-plan-2026-07-27.md` Phase 0c exists to prevent.
...
Stop after any phase and the tree is green. Phase 7 of `docs/history/refactor-plan-2026-07-27.md` (the
