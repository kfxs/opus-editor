...
> `docs/history/vexflow-removal-map.md` §9. ⭐ **This file is kept as the record of the reasoning** — §4's test
...
> ---
>
> 📄 ⭐⭐ **SEQUEL, 2026-08-16 — `docs/plans/own-engraving-engine.md`.** This document asks *which DECISION
...
MuseScore's 2.63) and was judged on screen: *"i think is ok now"*. `docs/research/spacing-model-research.md` §6d has all five engines contrasted,
...
(docs/research/spacing-model-research.md §6). So the box is added exactly where a flag is DRAWN, asked of
