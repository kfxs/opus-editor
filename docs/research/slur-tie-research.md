...
> 📄 Written the way `docs/research/stem-length-research.md` and `docs/research/beam-slope-research.md` are written.
...
⭐ **Two of the four treatises had never been asked this question.** `docs/plans/slur-plan.md` §11.7
...
3. ⭐⭐ **It resolves what `docs/plans/slur-plan.md` §13.2 left open.** §13.2 could not decide whether
...
- **Gedan, *Notenschrift für Fortgeschrittene*** — quoted in `docs/plans/slur-plan.md` §11.7 (2026-08-15) for the melodic-direction rule and the two labelled faults. ⛔ **It is not in `reference/`** and was not re-read today; that material is second-hand here.
