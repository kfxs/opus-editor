...
> 📄 Research for **P5c** of `docs/plans/own-engraving-engine.md` (*"the staff line's THICKNESS — ⛔ gated,
> and it is a taste call"*), and the sibling of `docs/research/header-spacing-research.md`, which takes the
...
- **The stem's thickness**, which is the other half of the *"thinner than a staff line"* relation.
  It has its own research: `docs/research/stem-length-research.md` — three books say *thinner*, none gives a
