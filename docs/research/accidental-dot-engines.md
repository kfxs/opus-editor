...
from `Rest::getDotline()` (`dom/rest.cpp:343-366` — 🚨 corrected 2026-09-25, it read `:2060-2083`, which the 739-line file does not have): whole/measure `+1` (+0.5 sp), 32nd/64th `−3`
