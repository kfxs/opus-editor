...
> 📄 Research for **P5b** of `docs/plans/own-engraving-engine.md` (*"the HEADER RUN — clef, key, meter, and
> the gaps between them"*), and the sibling of `docs/research/staff-line-research.md`, which takes the other
...
1. **A line-number drift.** `docs/research/clef-spacing-research.md:663–664` cites
...
- **Ross's own plates, measured for these gaps.** His numbers were converted arithmetically from
  ...
  reproduction quality (§3.4 of `docs/research/staff-line-research.md`) is why.
