...
> 📄 Research for **P4c** of `docs/plans/beam-engraving-plan.md` (itself P4 of
> `docs/plans/own-engraving-engine.md`). ⛔ **This document decides nothing.** It is the thing §3 of the
...
> ⭐⭐ Unlike the slope (`docs/research/beam-slope-research.md`), **this one is not a taste call**: the books
...
REVIEW after the VexFlow removal: `docs/history/vexflow-removal-map.md` §9.4 #1.
...
break (⏸️ TODO / REVIEW, `docs/history/vexflow-removal-map.md` §9.4 #1). A complete **B** means owning
