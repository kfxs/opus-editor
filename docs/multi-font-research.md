...
>
> 📄 Builds on `docs/smufl-fonts-research.md`, which is not repeated here. That document covers which
> free fonts exist, their licences, which of them ship metadata (§3), and how a font would arrive (§5).
> Read `docs/font-metrics-plan.md` for how our metrics table is generated, and
