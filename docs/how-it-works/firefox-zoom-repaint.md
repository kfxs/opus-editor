...
three-page spread is 3648 × 1697 px at 100% (`docs/plans/zoom-plan.md` §3: scale without re-rendering,
deliberately).
...
- `docs/plans/zoom-plan.md` §3 — why the transform approach was chosen; option 1 revises it.
