...
bar-width gesture hangs off (`Shift+Alt+←/→`, docs/plans/bar-width-plan.md).
...
> `docs/plans/barline-types-plan.md` §8 P5b for the sign that is not one.
...
> ⭐ **The first of those is now BUILT — `docs/plans/barline-types-plan.md`** (planned and P0–P2 shipped
