...
Research + decision, 2026-08-13. Raised by the trill (`docs/plans/trill-plan.md`), but the question asked
...
`docs/plans/dynamics-line-and-hairpins-plan.md` §12 opened this and deliberately left it open. This file
...
> `docs/plans/ottava-plan.md` §1 rule 5, §5 and P9.
>
...
`docs/plans/pedal-plan.md` §12.1–2 already owes his eye five numbers of this kind. The honest next step is
