...
instrument — is `docs/plans/playback-semantics-plan.md`, and ⛔ it must not wait for this nor grow to
include it.
...
Related: `docs/plans/key-signature-plan.md` — *`fifths` is the shorthand, never the storage*; the same
