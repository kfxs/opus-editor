...
| **S9h-b** | the softmax gone — `spacingPass` writes every context, and the bar-end clef gets a written x | ⚠️ **the bar-end clef moves** unless its softmax x is reproduced — HIS call |
