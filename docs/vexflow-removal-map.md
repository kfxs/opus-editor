...
| **S9c–f** | ✅ **S9c** `Dot.format` · ✅ **S9d** `Accidental.format` · ✅ **S9e** `Articulation.format` · one rule at a time into `engrave/`: `Dot.format`, `Accidental.format`, `Articulation.format`, `Annotation.format` (this is S5b–e, unblocked by S9b) | exact, each |
