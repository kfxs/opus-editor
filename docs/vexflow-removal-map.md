...
| **S9c–f** | one rule at a time into `engrave/`: `Dot.format`, `Accidental.format`, `Articulation.format`, `Annotation.format` (this is S5b–e, unblocked by S9b) | exact, each |
