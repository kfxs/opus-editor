...
import { keyRunTick } from '../walks/keyRun'
...
export function wireShortcuts(
  ...
  shortcutManager.registerActions({
    ...
    // `interactions/state/flipSelection.ts`'s table — it used to be a six-branch chain here, and the
    ...
    // insertion. WHICH passage and WHERE it lands is `interactions/state/repeatPassage.ts`; the decline
