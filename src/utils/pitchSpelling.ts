 ...
 * single caller of this on the playback path** (docs/plans/playback-semantics-plan.md — score → schedule →
 ...
 * can recover which of the two was written (docs/how-it-works/tuning-systems-and-alteration.md).
 */
