 ...
 */
import { addGrace, type GraceForm, type GraceWritten } from '../models/graceOps'
import type { Fraction, GraceNote, GraceSide, PitchSpelling } from '@/types/music'
...
export function graceCommands(ctx: CommandContext) {
  return {
     ...
     */
    addGrace(
      hostNoteId: string, side: GraceSide, spelling: PitchSpelling, form: GraceForm, written: GraceWritten, beat?: Fraction,
    ): GraceNote | null {
