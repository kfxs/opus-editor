 ...
 *
 * Sebastian's table for the 73 glyphs the editor draws — the SAME shape as
 ...
 *
 * 🚨 **1 glyph(s) this face does not draw are BRAVURA'S, whole** — box and anchors
...
export const FALLBACK_GLYPHS: readonly GlyphName[] = ['bracket']
