 ...
 * | which heads CROSS the stem (`buildNoteHeads`) | ⭐ **us** — `rendering/format/chordHeadLayout`, the fan's own walk | S6d, 2026-09-16 · ⭐ ONE owner at last |
 ...
 */
import type { TickColumn } from '../format/columnFormat'
...
import { acceptsInkSurface } from '../painter/inkSurface'
import { maybeStaveOf, requireNoteFrame, staveFrame, staveOf } from '../staff/staveFrame'
...
import { barVoiceOf } from '../format/barVoice'
...
export class EngravedNote {
   ...
   * apart: then the stem runs between them and the inner head crosses. `rendering/format/chordHeadLayout`
