 ...
 */
const TRILL_GLYPH_INK_ABOVE = drawnFontPx(TRILL_GLYPH_SIZE) * 0.62 // baseline → glyph top
const TRILL_GLYPH_INK_BELOW = drawnFontPx(TRILL_GLYPH_SIZE) * 0.04 // baseline → glyph bottom
