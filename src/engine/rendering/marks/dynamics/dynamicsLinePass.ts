...
import { dynamicGlyphInkAbove, dynamicGlyphInkBelow } from './dynamicStyle'
 ...
 */
export function markInk(): MarkInk {
  return { above: dynamicGlyphInkAbove() / STAFF_SPACE_PX, below: dynamicGlyphInkBelow() / STAFF_SPACE_PX }
}
