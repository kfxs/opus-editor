...
import { staveLineWidthPx, fillStaffLine, staffLinesInk } from '@/engine/engrave/staff/staffLines'
...
function drawOpenStaffTail(
  ...
  for (const ink of staffLinesInk(fromX, toX - fromX, ys, staveLineWidthPx())) {
