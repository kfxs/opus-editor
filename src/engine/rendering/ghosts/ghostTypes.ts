...
export type ToolGhost =
   ...
   * brackets, drawn as the ARMED value (B7 revised: a half's head is hollow), the armed accidental inside.
   */
  | { kind: 'bracketedGrace'; duration: NoteDuration; accidental: ScoreAccidental | null }
  /**
