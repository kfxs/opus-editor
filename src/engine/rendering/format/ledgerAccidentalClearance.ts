...
import { trimLedgers, EngravedNote } from '../engraved/EngravedNote'
 ...
 * VexFlow's: `rendering/format/accidentalPlacement` runs first and may have moved the whole column to the
