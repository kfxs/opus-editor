 ...
 * |---|---|---|
 * | where it comes from | `Element.getBoundingBox()` — this object's `x`/`y` fields plus a font measurement | the stamp that actually painted the sign (`rendering/painter/sceneInk`) |
...
import type { EngravedAccidental } from '../engraved/EngravedAccidental'
