 ...
 * most of them still paint themselves. ⭐ **One at a time, they stop** — the CLEF on 2026-09-02, the
 * METER after it, the opening BARLINE still to come (`docs/own-engraving-engine.md` P5b) — and each
 * one that has needs telling which surface to draw on.
 *
 ...
 *
 * ⚠️ **The guard is structural on purpose.** The members are `EngravedClef` and
 * `EngravedTimeSignature`, which have no common base but `StaveModifier` — VexFlow's own class tree —
