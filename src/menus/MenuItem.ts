 ...
 * discouraged.
 *
 * ⚠️ Checkmarks, radio groups, shortcut hints, disabled rows and icons are deliberately NOT here.
 * Each earns its place when a THIRD menu wants it — the same guard the widget toolkit lives under.
 *
