...
const GHOST_SELECTOR =
  '.ghost-note-group, .ghost-rest-group, .ghost-fan-group, .ghost-clef-group, .ghost-timesig-group, .ghost-dynamic-group, .vf-ghost-articulation, .vf-ghost-accidental, .vf-ghost-tie, .vf-ghost-dot, .vf-ghost-tremolo, .vf-ghost-tempo, .vf-ghost-trill'
